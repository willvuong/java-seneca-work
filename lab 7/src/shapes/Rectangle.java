...
public class Rectangle extends Parallelogram implements FunctionalShapeInterface { 
	...
	public double getArea() {
		FunctionalShapeInterface rectangleArea = () -> getWidth() * getHeight();
	...
	public String toString() {
		return ("Rectangle {w=" + getWidth() + ", h=" + getHeight() +"} perimeter = " + getPerimeter() + " area = " + getArea());
	}
}
